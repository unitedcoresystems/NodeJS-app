...
app.get('/united', function(request, response) {
    ...
    response.write("<h2><center>Welcome to  United Core . Please Contact +1 617 955 5115 / 774 515 0044 for more information or send an email to info@unitedcoresystem.com <center></h2>" );
    response.end();
...
app.get('/redirect', function(req, res) {
    //Send status 300
        res.redirect('http://unitedcoresystems.com');
    });
